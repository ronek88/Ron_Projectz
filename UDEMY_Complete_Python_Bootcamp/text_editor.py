...
class Editor:
    ...
    def markdowner(self, event=''):
        focus = root.focus_get()
        print
        markdown2.markdown(focus.get(1.0, END))
    ...
    def view_html(self, event=''):
        ...
        if (file_extension == ".md"):  # checks if it is markdown
            ...
            try:
                ...
                print
                "couldnt convert markdown to html"
    ...
    def about(self):
        ...
        info = Label(about_window,
                     text="""This is a text editor made by Luke Carlson (github.com/jLukeC) over a few days in summer 2013.""")
        info.pack()
